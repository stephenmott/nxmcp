...
type
  ...
  /// </summary>
  TDropTableTool = class(TSerializedToolBase<TDropTableParams>)
  protected
...
begin
  ...
  // Delete the table (auto-reconnects and retries once on lost connection;
  // retry of a successful drop just returns "table not found", which is harmless)
